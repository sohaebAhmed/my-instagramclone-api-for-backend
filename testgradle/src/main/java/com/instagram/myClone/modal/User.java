...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", image=" + image + ", password=" + password + ", username=" + username + ", name="
				+ name + ", email=" + email + ", mobile=" + mobile + ", website=" + website + ", bio=" + bio
				+ ", gender=" + gender + ", follower=" + follower + ", following=" + following + "]";
	}
